...
public class LookupEndpointIntegrationTests
{
    ...
    [Fact]
    public async Task GetShowByTvRageIdAsync_ValidParameter_Success()
    {
        // arrange
        // Maps to tvmaze id 1
    ...
    [Fact]
    public async Task GetShowByTvRageIdAsync_ValidParameter_NotFound()
    {
        // arrange
    ...
    [Fact]
    public async Task GetShowByTheTvdbIdAsync_ValidParameter_Success()
    {
        // arrange
    ...
    [Fact]
    public async Task GetShowByTheTvdbIdAsync_ValidParameter_NotFound()
    {
        // arrange
    ...
    [Fact]
    public async Task GetShowByImdbIdAsync_ValidParameter_Success()
    {
        // arrange
    ...
    [Fact]
    public async Task GetShowByImdbIdAsync_ValidParameter_NotFound()
    {
        // arrange
