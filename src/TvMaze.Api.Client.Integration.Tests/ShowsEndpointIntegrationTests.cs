...
public class ShowsEndpointIntegrationTests
{
    ...
    [Fact]
    public async Task GetShowMainInformationAsync_ValidParameter_Success()
    {
        // arrange
    ...
    [Fact]
    public async Task GetShowMainInformationAsync_ValidParameter_EmbedEpisodes_Success()
    {
        // arrange
        const int showId = 1;
    ...
    [Fact]
    public async Task GetShowMainInformationAsync_ValidParameter_EmbedPreviousEpisode_Success()
    {
        // arrange
        const int showId = 1;
    ...
    [Fact]
    public async Task GetShowMainInformationAsync_ValidParameter_EmbedCast_Success()
    {
        // arrange
        const int showId = 1;
    ...
    [Fact]
    public async Task GetShowMainInformationAsync_ValidParameter_EmbedMultiple_Success()
    {
        // arrange
        const int showId = 1;
    ...
    [Fact]
    public async Task GetShowMainInformationAsync_ValidParameter_NotFound()
    {
        // arrange
    ...
    [Fact]
    public async Task GetShowMainInformationAsync_InvalidId_ThrowsArgumentException()
    {
        // arrange
    ...
    [Fact]
    public async Task GetEpisodeListAsync_ValidParameter_Success()
    {
        // arrange
        const int validShowId = 1;
    ...
    [Fact]
    public async Task GetEpisodeListAsync_ValidParameter_WithSpecials_Success()
    {
        // arrange
        const int validShowId = 1;
    ...
    [Fact]
    public async Task GetEpisodeListAsync_ValidParameter_NotFound()
    {
        // arrange
        const int notFoundShowId = int.MaxValue;
    ...
    [Fact]
    public async Task GetEpisodeListAsync_InvalidId_ThrowsArgumentException()
    {
        // arrange
        const int invalidShowId = 0;
    ...
    [Fact]
    public async Task GetShowSeasonsAsync_ValidParameter_Success()
    {
        // arrange
        const int validShowId = 1;
    ...
    [Fact]
    public async Task GetShowSeasonsAsync_ValidParameter_NotFound()
    {
        // arrange
        const int notFoundShowId = int.MaxValue;
    ...
    [Fact]
    public async Task GetShowSeasonsAsync_InvalidId_ThrowsArgumentException()
    {
        // arrange
        const int invalidShowId = 0;
    ...
    [Fact]
    public async Task GetSeasonEpisodesAsync_ValidParameter_Success()
    {
        // arrange
    ...
    [Fact]
    public async Task GetSeasonEpisodesAsync_ValidParameter_NotFound()
    {
        // arrange
    ...
    [Fact]
    public async Task GetSeasonEpisodesAsync_InvalidId_ThrowsArgumentException()
    {
        // arrange
    ...
    [Fact]
    public async Task GetEpisodeByNumberAsync_ValidParameter_Success()
    {
        // arrange
        const int validShowId = 1;
    ...
    [Fact]
    public async Task GetEpisodeByNumberAsync_ValidParameter_NotFound()
    {
        // arrange
        const int notFoundShowId = int.MaxValue;
        const int validSeason = 1;
    ...
    [InlineData(1, 0, 1)]
    [InlineData(1, 1, 0)]
    public async Task GetEpisodeByNumberAsync_InvalidParameters_ThrowsArgumentException(int showId, int season, int number)
    {
        // act
    ...
    [Fact]
    public async Task GetEpisodesByDateAsync_ValidParameter_Success()
    {
        // arrange
        const int validShowId = 1;
    ...
    [Fact]
    public async Task GetEpisodesByDateAsync_ValidParameter_NoEpisodeFound()
    {
        // arrange
        const int validShowId = 1;
    ...
    [Fact]
    public async Task GetEpisodesByDateAsync_InvalidId_ThrowsArgumentException()
    {
        // arrange
        const int invalidShowId = 0;
    ...
    [Fact]
    public async Task GetShowCastAsync_ValidParameters_Success()
    {
        // arrange 
        const int validShowId = 1;
    ...
    [Fact]
    public async Task GetShowCastAsync_ValidParameters_NotFound()
    {
        // arrange
        const int notFoundShowId = int.MaxValue;
    ...
    [Fact]
    public async Task GetShowCastAsync_InvalidId_ThrowsArgumentException()
    {
        // arrange
        const int invalidShowId = 0;
    ...
    [Fact]
    public async Task GetShowCrewAsync_ValidParameters_Success()
    {
        // arrange 
        const int validShowId = 1;
    ...
    [Fact]
    public async Task GetShowCrewAsync_ValidParameters_NotFound()
    {
        // arrange 
        const int notFoundShowId = int.MaxValue;
    ...
    [Fact]
    public async Task GetShowCrewAsync_InvalidId_ThrowsArgumentException()
    {
        // arrange
        const int invalidShowId = 0;
    ...
    [Fact]
    public async Task GetShowAkas_ValidParameters_Success()
    {
        // arrange 
        const int validShowId = 1;
    ...
    [Fact]
    public async Task GetShowAkas_ValidParameters_NotFound()
    {
        // arrange 
        const int notFoundShowId = int.MaxValue;
    ...
    [Fact]
    public async Task GetShowAkas_InvalidId_ThrowsArgumentException()
    {
        // arrange
        const int invalidShowId = 0;
    ...
    [Fact]
    public async Task GetShowImagesAsync_ValidParameters_Success()
    {
        // arrange 
        const int validShowId = 1;
    ...
    [Fact]
    public async Task GetShowImagesAsync_ValidParameters_NotFound()
    {
        // arrange 
        const int notFoundShowId = int.MaxValue;
    ...
    [Fact]
    public async Task GetShowImagesAsync_InvalidId_ThrowsArgumentException()
    {
        // arrange
        const int invalidShowId = 0;
    ...
    [Fact]
    public async Task GetShowsAsync_ValidParameters_Success()
    {
        // arrange 
    ...
    [Fact]
    public async Task GetShowsAsync_ValidParameters_NotFound()
    {
        // arrange 
    ...
    [Fact]
    public async Task GetShowsAsync_InvalidPage_ThrowsArgumentException()
    {
        // arrange
