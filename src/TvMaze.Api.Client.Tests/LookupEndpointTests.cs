...
public class LookupEndpointTests : IDisposable
{
    ...
    [Fact]
    public async Task GetShowByTvRageIdAsync_ValidId_CallsCorrectUrl()
    {
        // arrange
    ...
    [Fact]
    public async Task GetShowByTvRageIdAsync_ValidId_ReturnsExpectedShow()
    {
        // arrange
        var tvRageId = _fixture.Create<int>();
    ...
    [Fact]
    public async Task GetShowByTvRageIdAsync_ValidIdNotFound_ReturnsNull()
    {
        // arrange
        var tvRageId = _fixture.Create<int>();
    ...
    [Fact]
    public async Task GetShowByTvRageIdAsync_InvalidId_ThrowsArgumentException()
    {
        // arrange
    ...
    [Fact]
    public async Task GetLookupByTheTvdbId_InvalidId_ThrowsArgumentException()
    {
        // arrange
    ...
    [Fact]
    public async Task GetLookupByImdbId_InvalidId_ThrowsArgumentNullException()
    {
        // arrange
